...
```text
├── spam_detection.py      # Full NLP pipeline & classifier script
...
1. **Clone the repo:** `git clone https://github.com/yourusername/spam-detection.git`
2. **Install dependencies:** `pip install pandas scikit-learn joblib`
3. **Execute:** `python spam_detection.py`
